...
ax.plot(x_orig, cp_orig, "r-", linewidth=2.5, label="Original overlap")
ax.plot(x_gap2, cp_gap2, "b-", linewidth=2.5, label="+2% flap overlap")
...
ax.set_title(
    "Cp vs x/c – NLR7301 with flap at 10 degrees (Original vs +2% Overlap)",
    fontsize=14,
    fontweight="bold"
)
